	...
	renderOverview: function(zones) {
		...
		s.addModalOptions = function(s) {
			return network.getWifiNetwork(s.section).then(function(radioNet) {
				...
				o = ss.taboption('general', form.Value, 'channels', _('Use specific channels'), _('Limit channels to scan. When background radar is enabled this option allows hostapd to scan the provided channels. Channels can be provided as range using hyphen (-) or individual channels can be specified by space ( ) separated values. Example: (36 44 100 104)'));
				o.optional = true;
